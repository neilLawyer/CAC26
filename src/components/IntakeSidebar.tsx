...
const STEP_NOTES: Record<string, string> = {
  state: "Program rules — income limits, age requirements — are set state by state, so we start here to tailor every question after this.",
  ...
  income: "Most programs use a percentage of the federal poverty level based on household size. A range is all we need — nothing exact.",
  flags: "Some programs, like PAAD or Senior Freeze, are restricted to specific groups. We only ask about the ones that could still apply to you.",
  review: "That's everything we need. Your answers stay in this browser and are never sent anywhere.",
};
